  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="relative overflow-hidden p-6 border-border/50 shadow-sm transition-all hover:shadow-md group">
          <div className="absolute top-0 right-0 p-4 opacity-10 transform translate-x-4 -translate-y-4 group-hover:scale-110 transition-transform duration-500">
            <Users className="h-24 w-24 text-blue-600" />
          </div>
          <div className="relative z-10">
            <div className="h-10 w-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-600 mb-4 ring-1 ring-blue-500/20">
        ...
        <Card className="relative overflow-hidden p-6 border-border/50 shadow-sm transition-all hover:shadow-md group">
          ...
          <div className="relative z-10">
            <div className="h-10 w-10 rounded-xl bg-indigo-500/10 flex items-center justify-center text-indigo-600 mb-4 ring-1 ring-indigo-500/20">
        ...
        <Card className="relative overflow-hidden p-6 border-border/50 shadow-sm transition-all hover:shadow-md group">
          ...
          <div className="relative z-10">
            <div className="h-10 w-10 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-600 mb-4 ring-1 ring-emerald-500/20">
        ...
        <Card className="relative overflow-hidden p-6 border-border/50 shadow-sm transition-all hover:shadow-md group bg-gradient-to-br from-bg to-bg-soft">
          <div className="absolute top-0 right-0 p-4 opacity-10 transform translate-x-4 -translate-y-4 group-hover:scale-110 transition-transform duration-500">
            <Activity className="h-24 w-24 text-accent" />
          </div>
          <div className="relative z-10">
            <div className="h-10 w-10 rounded-xl bg-accent/10 flex items-center justify-center text-accent mb-4 ring-1 ring-accent/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="flex flex-col border-border/50 shadow-sm overflow-hidden transition-all hover:shadow-md">
          <div className="p-5 bg-bg-soft/30 border-b border-border/50 flex items-center gap-3">
            <div className="p-2 bg-amber-100/50 rounded-lg text-amber-600 ring-1 ring-amber-500/20">
        ...
        <Card className="flex flex-col border-border/50 shadow-sm overflow-hidden transition-all hover:shadow-md">
          <div className="p-5 bg-bg-soft/30 border-b border-border/50 flex items-center gap-3">
            <div className="p-2 bg-indigo-100/50 rounded-lg text-indigo-600 ring-1 ring-indigo-500/20">
      ...
      <Card className="border-border/50 shadow-sm overflow-hidden transition-all hover:shadow-md">
        <div className="p-5 bg-bg-soft/30 border-b border-border/50 flex items-center gap-3">
          <div className="p-2 bg-purple-100/50 rounded-lg text-purple-600 ring-1 ring-purple-500/20">
            <FlaskConical className="h-5 w-5" />
          </div>
          <h3 className="font-semibold text-lg text-ink tracking-tight">Rendimiento Departamental</h3>
        </div>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-border/50 bg-white">
          
          {/* Lab */}
          <div className="space-y-5 md:pr-8">
            <div className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-50 text-blue-600 ring-1 ring-blue-500/20 shadow-sm">
                <Activity className="h-5 w-5" />
              </span>
              <h4 className="font-bold text-ink text-lg tracking-tight">Laboratorio Clínico</h4>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-emerald-50 to-green-50/20 border border-emerald-100/80 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow group">
                ...
                <p className="text-3xl font-extrabold text-emerald-700 tracking-tight">${(stats as any)?.labMetrics?.labIncome?.lab?.toFixed(2) || "0.00"}</p>
              </div>
              <div className="bg-gradient-to-br from-rose-50 to-red-50/20 border border-rose-100/80 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow group">
                ...
                <p className="text-3xl font-extrabold text-rose-700 tracking-tight">${(stats as any)?.labMetrics?.labExpense?.lab?.toFixed(2) || "0.00"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5 md:pl-8 pt-6 md:pt-0">
            <div className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 ring-1 ring-indigo-500/20 shadow-sm">
                <Activity className="h-5 w-5" />
              </span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-emerald-50 to-green-50/20 border border-emerald-100/80 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow group">
                ...
                <p className="text-3xl font-extrabold text-emerald-700 tracking-tight">${(stats as any)?.labMetrics?.labIncome?.imaging?.toFixed(2) || "0.00"}</p>
              </div>
              <div className="bg-gradient-to-br from-rose-50 to-red-50/20 border border-rose-100/80 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow group">
                <p className="text-xs uppercase tracking-wider text-rose-700/80 font-bold mb-1.5 flex items-center gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-rose-500"></span> Egresos
                </p>
                <p className="text-3xl font-extrabold text-rose-700 tracking-tight">${(stats as any)?.labMetrics?.labExpense?.imaging?.toFixed(2) || "0.00"}</p>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-12">
        ...
        <Card className="col-span-1 lg:col-span-2 flex flex-col border-border/50 shadow-sm overflow-hidden transition-all hover:shadow-md">
          <div className="p-5 bg-bg-soft/30 border-b border-border/50 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-blue-100/50 rounded-lg text-blue-600 ring-1 ring-blue-500/20">
                <Users className="h-5 w-5" />
              </div>
              <h3 className="font-semibold text-lg text-ink tracking-tight">Directorio del Equipo</h3>
            </div>
            <span className="text-xs font-bold bg-accent/10 text-accent px-3 py-1.5 rounded-full ring-1 ring-accent/20">
        ...
        <div className="space-y-4">
          <Card className="p-6 border-border/50 shadow-sm h-full flex flex-col bg-gradient-to-br from-white to-bg-soft/50 transition-all hover:shadow-md relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-4 opacity-5 transform translate-x-4 -translate-y-4 group-hover:scale-110 transition-transform duration-500">
              <Settings className="h-32 w-32 text-ink" />
            </div>
            
            <h3 className="font-semibold text-lg mb-6 flex items-center gap-3 relative z-10">
              <div className="p-2 bg-gray-100 rounded-lg text-gray-600 shadow-inner ring-1 ring-gray-200">
            ...
            <div className="space-y-4 flex-1 relative z-10">
              <div className="bg-white rounded-2xl p-5 border border-border/80 shadow-sm group/plan hover:border-accent/40 transition-all hover:shadow-md">
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-10 w-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 ring-1 ring-blue-500/20 group-hover/plan:scale-110 transition-transform">
                    <Activity className="h-5 w-5" />
                  </div>
              ...
              <Link href="/billing" className="block w-full mt-auto pt-4">
                <Button variant="outline" className="w-full justify-between bg-white border-border/80 shadow-sm hover:border-accent/50 hover:text-accent hover:shadow-md transition-all h-14 rounded-xl font-medium">
                  <span className="flex items-center gap-3">
                    <div className="p-1.5 bg-bg-soft rounded-md">
