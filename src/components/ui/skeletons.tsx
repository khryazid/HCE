...
export function DashboardSkeleton() {
  return (
    <section className="space-y-6" role="status" aria-busy="true" aria-label="Cargando panel principal..." style={{ minHeight: "70vh" }}>
      {/* Header */}
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--bg-soft)] p-4 space-y-3">
...
export function ConsultasSkeleton() {
  return (
    <section className="space-y-6" role="status" aria-busy="true" aria-label="Cargando modulo de consultas..." style={{ minHeight: "70vh" }}>
      {/* Header */}
      ...
      {/* Wizard placeholder */}
      <div className="rounded-3xl border border-[color:var(--border)] bg-[color:var(--card)] p-5 shadow-sm space-y-4">
...
export function PacientesSkeleton() {
  return (
    <section className="space-y-6" role="status" aria-busy="true" aria-label="Cargando lista de pacientes..." style={{ minHeight: "70vh" }}>
      {/* Header */}
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--card)] p-4 space-y-3">
            <SkeletonLine width="60%" height="0.65rem" />
            <SkeletonLine width="3rem" height="1.5rem" />
          </div>
        ))}
      ...
      <div className="grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
        <div className="rounded-3xl border border-[color:var(--border)] bg-[color:var(--card)] p-4 space-y-3">
