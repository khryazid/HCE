        ...
        <article className="order-2 rounded-3xl border border-white/80 bg-white/75 p-6 shadow-2xl shadow-cyan-900/10 backdrop-blur sm:p-8 lg:order-1">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3">
              <p className="text-sm font-semibold text-slate-900">Acceso unico</p>
              <p className="mt-1 text-sm text-slate-600">Inicia sesion y retoma tu flujo clinico sin friccion.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3">
              <p className="text-sm font-semibold text-slate-900">Seguridad tenant</p>
              <p className="mt-1 text-sm text-slate-600">Datos segregados por medico y clinica con RLS.</p>
            </div>
          </div>
